...
TEST(PoolPerformanceTest, fullTest)
{
    ...
    endPerformance("PoolPerformanceTest::fullTest",ITERATION);
}
TEST(PoolPerformanceTest, allocTest)
{
    const uint32 POOL_SIZE = 50000000;
    PoolMemory pm { POOL_SIZE };
    ...
    endPerformance("PoolPerformanceTest::allocTest",ITERATION);
}
TEST(PoolPerformanceTest, deallocTest)
{
    const uint32 POOL_SIZE = 50000000;
    PoolMemory pm { POOL_SIZE };
    const uint32 ALLOC_SIZE=735;
    ...
    endPerformance("PoolPerformanceTest::deallocTest",ITERATION);
}
